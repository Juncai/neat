...
bool Population::epoch(int generation) {
	...
	//	std::cout << "The fitness of organism at the begin of epoch is: " << (*curorg)->fitness << std::endl;
	//}
	int max_expected;
	...
	*/
	...
	for(curorg=organisms.begin();curorg!=organisms.end();++curorg) {
		total+=(*curorg)->fitness;
		//std::cout << "The fitness of organism in epoch is: " << (*curorg)->fitness << std::endl;
	}
	overall_average=total/total_organisms;
	/*std::cout << "The number of organisms in epoch is: " << total_organisms << std::endl;
	std::cout << "The total fitness of organisms in epoch is: " << total << std::endl;*/
